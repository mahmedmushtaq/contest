...
public class OtherUserProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileActivityClass.setCheck(KeyStore.OTHER_USER_PROFILE);
        ...
        rv = new ProfileRv();
        rv.setCheck(KeyStore.OTHER_USER_PROFILE);
    ...
    private void getProfileInfo() {
        ...
        profileInfoProcess.setProfileInfoListener(new ProfileInfoProcess.profileInfoListener() {
            ...
            public void onSuccess(final ProfileHeaderData data) {
                postProfileData = new BackgroundTaskLoadNewData();
        ...
        if(passUsername.equalsIgnoreCase(mSharedPrefer.getUsername())){
            ...
            intent.putExtra(KeyStore.PASS_DATA,mSharedPrefer.getUsername());
            startActivity(intent);
            Animatoo.animateSlideUp(OtherUserProfileActivity.this);
        }else{
          //  Toaster.setToaster(this,"Other User Activity");
            Log.e("profilecheck", "getProfileInfo: Other user profile" );
...
//    ================= BODY CODE =======================
    ...
    protected void notifyItemSelected(int position) {
        if(mRecyclerView != null && !mArrayHolder.getProfileHeaderData().isEmpty() && !mArrayHolder.getOtherUserProfileData().isEmpty()){
            mArrayHolder.getOtherUserProfileData().clear();
