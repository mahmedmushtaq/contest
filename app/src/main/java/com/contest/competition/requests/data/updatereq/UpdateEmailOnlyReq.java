...
public class UpdateEmailOnlyReq {
    ...
    public static void updateData(String value, String username, final Context context){
        ...
        RequestBody body =  new FormBody.Builder()
                ...
                .add("update_email",value)
                .build();
        Request request = new Request.Builder().url(Addresses.getWebAddress()+ UpdateDataFiles.updateEmail).post(body).build();
