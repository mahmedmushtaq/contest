...
public class RetrieveFollowersReq {
    ...
    public void getData(String username, String last_id){
        ...
        Request request = new Request.Builder().url(Addresses.getWebAddress()+ FollowFiles.followerUserInfoFile).post(body).build();
                        ...
                        try {
                            ...
                            if(Validator.validateWebResult(result)){
                                ...
                                for(int i = 0 ; i < namesArray.length() ; i++){
                                    ...
                                    //ArrayHolder.followerData.add(data);
                                    ...
                                    mArrayHolder.setFollowerData(data);
                                ...
                                if(mOnLoadingFollowFeaturesData != null){
                                    ((Activity)mContext).runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            mOnLoadingFollowFeaturesData.onLoad(mArrayHolder.getFollowerData());
                                        }
                                    });
                                }
